...
const GeneratePage = () => {
  ...
  return (
    <div className="app-container" style={{ backgroundColor: '#0b1220', color: '#e5e7eb' }}>
      ...
      <main className="main-content">
        <div className="content-container" style={{ maxWidth: '56rem' }}>
          <h1 className="main-title" style={{ marginBottom: '0.5rem' }}>Google's AI Gemini</h1>
          ...
          <div style={{ background: '#111827', border: '1px solid #1f2937', borderRadius: '0.75rem', padding: '1rem' }}>
            <label htmlFor="ingredients" style={{ display: 'block', color: '#9ca3af', marginBottom: '0.5rem' }}>
              Ingredients
            </label>
            <textarea
              id="ingredients"
            ...
            <div style={{ display: 'flex', gap: '0.75rem', marginTop: '1rem' }}>
              ...
              {result && (
                <button className="primary-btn" onClick={handleCopy} style={{ background: '#374151' }}>
          ...
          {result && (
            <div style={{ marginTop: '1rem', background: '#0f172a', border: '1px solid #1f2937', borderRadius: '0.75rem', padding: '1rem' }}>
              <pre style={{ whiteSpace: 'pre-wrap', wordBreak: 'break-word', margin: 0, fontFamily: 'ui-monospace, SFMono-Regular, Menlo, monospace' }}>
                {result}
              </pre>
            </div>
          )}
