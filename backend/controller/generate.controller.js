...
const generateController = {
  generateRecipe: async (req, res) => {
    try {
      ...
      const recipe = await generateService.generateRecipeForUser(Number(userId), ingredients);
      return res.status(201).json({ message: 'Recipe generated successfully', recipe });
    } catch (err) {
